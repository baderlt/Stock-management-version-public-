...
<motion.span className="basis-[60%]" animate={{padding:'20px'  }}>
<h1 className="text-xl "><b><u>Sélectionnez la date de stock</u></b></h1>
</motion.span>
<span className="basis-[40%]  pt-2 pr-2  text-right ">
        <NouveauStockDrawer/>      
                {/* <Drawer> cc</Drawer> */}
            </span>
           
            </div> 
            <motion.div animate={{marginLeft:'20px'}}>
        ...
        <motion.div animate={{marginTop:'40px', marginLeft:'20px'}}>
        <ButtonGroup variant="text" size="large" className=" flex   w-full  "  >
